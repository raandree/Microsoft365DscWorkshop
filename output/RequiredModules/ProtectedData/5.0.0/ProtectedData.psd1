...
FunctionsToExport = @('Add-ProtectedDataCredential','Add-ProtectedDataHmac','Get-KeyEncryptionCertificate','Get-ProtectedDataSupportedTypes','Protect-Data','Remove-ProtectedDataCredential','Unprotect-Data')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '## [5.0.0-test] - 2024-04-26
